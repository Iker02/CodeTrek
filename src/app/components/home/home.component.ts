...
export class HomeComponent implements OnInit {
  ...
  allCourses: Course[] = [
    {
      title: 'Python',
      descriptionKey: 'homepage.courses.each_course.description_Python',
      image: '../assets/lenguaje-python.jpg',
    },
    {
      title: 'CSharp',
      descriptionKey: 'homepage.courses.each_course.description_CSharp',
      image: '../assets/C.jpg',
    },
    {
      title: 'VisualBasic',
      descriptionKey: 'homepage.courses.each_course.description_VisualBasic',
      image: '../assets/visualBasic.jpg',
    },
    {
      title: 'SQL',
      descriptionKey: 'homepage.courses.each_course.description_SQL',
      image: '../assets/SQL.jpg',
    },
    {
      title: 'Kotlin',
      descriptionKey: 'homepage.courses.each_course.description_Kotlin',
      image: '../assets/Kotlin.png',
    },
    {
      title: 'JavaScript',
      descriptionKey: 'homepage.courses.each_course.description_JavaScript',
      image: '../assets/JS-picture.jpg',
    },
    {
      title: 'Java',
      descriptionKey: 'homepage.courses.each_course.description_Java',
      image: '../assets/java-picture.jpg',
    },
    {
      title: 'HTML',
      descriptionKey: 'homepage.courses.each_course.description_HTML',
      image: '../assets/html-picture.jpg',
    },
  ];
  ...
  // Progreso de cursos (niveles completados / total niveles)
  ...
  async loadProgress() {
    ...
    if (user) {
      try {
        ...
        // En caso de error inicializar a 0/5
        this.allCourses.forEach((course) => {
          const key = course.title.toLowerCase();
  ...
  // Controla cuantos cursos se muestran en pantalla
  toggleCourses(): void {
